...
Do not commit real secrets. Keep tokens in environment variables such as `TELEGRAM_BOT_TOKEN`, `MISTRAL_API_KEY`, and `OPENAI_API_KEY`, and use `config.yaml.example` as the template for local setup.
